@php($title = 'Tambah Pesanan Makanan')
@extends('layouts.app')
@section('content')
<div class="card">
  <div class="card-title" style="margin-bottom:12px;">Form Pesanan</div>
  <form method="POST" action="{{ route('pesanan-makanan.store') }}">@csrf
    <div style="display:grid;grid-template-columns:1fr 1fr;gap:12px;">
      ...
      <div><label>Total Bayar</label><input name="total_bayar" type="number" step="any" style="width:100%;padding:10px;border:1px solid #e5e7eb;border-radius:8px"></div>
    </div>
