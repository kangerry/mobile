@php($title = 'Tambah Pesanan Ojek')
@extends('layouts.app')
@section('content')
<div class="card">
  <div class="card-title" style="margin-bottom:12px;">Form Pesanan Ojek</div>
  <form method="POST" action="{{ route('pesanan-ojek.store') }}">@csrf
    <div style="display:grid;grid-template-columns:1fr 1fr;gap:12px;">
      ...
      <div><label>Nomor Pesanan</label><input name="nomor_pesanan" style="width:100%;padding:10px;border:1px solid #e5e7eb;border-radius:8px"></div>
      <div>
        <label>Anggota</label>
      ...
      <div style="grid-column:1/-1;"><label>Alamat Jemput</label><input name="alamat_jemput" style="width:100%;padding:10px;border:1px solid #e5e7eb;border-radius:8px"></div>
      <div style="grid-column:1/-1;"><label>Alamat Tujuan</label><input name="alamat_tujuan" style="width:100%;padding:10px;border:1px solid #e5e7eb;border-radius:8px"></div>
    </div>
